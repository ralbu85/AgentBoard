...
<p align="center">
  <img src="docs/screenshots/demo-desktop.gif" alt="격자 보기: 병렬로 일하는 에이전트 셋 — 하나가 승인을 요청하면 ⏎ 한 번으로 승인, 이어서 완료까지" width="100%">
</p>
<p align="center">
  <img src="docs/screenshots/demo-mobile.gif" alt="폰: 대기 중인 에이전트를 열어 빠른 승인 바에서 Yes 탭, 완료까지 지켜보기" width="41%">
  &nbsp;
  <img src="docs/screenshots/mobile-folders.png" alt="폰 화면: 폴더별 실시간 상태 칩이 달린 워크스페이스 목록" width="41%">
</p>

<p align="center"><i>AgentBoard로 구동한 실제 Claude Code 세션 (각색 없음) — rate limiting을 구현하고
테스트 클라이언트로 검증한 뒤 결과를 보고합니다:</i></p>
<p align="center">
  <img src="docs/screenshots/demo-real-claude.gif" alt="AgentBoard의 실제 Claude Code 세션: src/server.py에 slowapi rate limiting을 추가하고 TestClient로 429를 검증한 뒤 변경 내용을 요약" width="100%">
</p>

<details>
<summary><b>데모 더 보기</b> — 파일 워크스페이스와 리뷰 → 에이전트 루프</summary>
<br>
<p align="center">
  <img src="docs/screenshots/demo-files.gif" alt="파일 워크스페이스: 파일 업로드, 렌더된 마크다운 읽기, 체크박스 클릭(파일에 저장), 코드 편집·저장" width="100%">
</p>
<p align="center">
  <img src="docs/screenshots/demo-review.gif" alt="리뷰 루프: 뷰어에서 코드를 선택해 메모를 달고 전송하면 에이전트 프롬프트에 바로 도착" width="100%">
</p>
</details>
