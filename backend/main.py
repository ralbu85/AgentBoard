...
from .notebooks import manager as notebook_manager
...
async def lifespan(app: FastAPI):
    ...
    notebook_reaper = asyncio.create_task(notebook_manager.reap())
    yield

    notebook_reaper.cancel()
    await asyncio.gather(notebook_reaper, return_exceptions=True)
    await notebook_manager.shutdown()
